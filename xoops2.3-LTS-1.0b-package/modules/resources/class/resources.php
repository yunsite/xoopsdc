...
class ResourcesResources extends XoopsObject
{
    function __construct() {    
        ...
        $this->initVar('res_attachment', XOBJ_DTYPE_INT, 0, false);
        $this->initVar('res_status', XOBJ_DTYPE_INT, 0, false);
        $this->initVar('res_weight', XOBJ_DTYPE_INT, 0, false);
        ...
        $this->initVar('res_counter', XOBJ_DTYPE_INT, null, false);        
        $this->initVar('res_counter', XOBJ_DTYPE_INT, null, false);
        $this->initVar('res_rating', XOBJ_DTYPE_INT, null, false);
        $this->initVar('res_rates', XOBJ_DTYPE_INT, null, false);           
    }
