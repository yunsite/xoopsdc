...
$form->addElement(new XoopsFormText(_AM_BLKDESC, 'bname', 50, 255, $block['name']), false);  //ezsky hack 

$side_select = new XoopsFormSelect(_AM_BLKTYPE, "bside", $block['side']);
$side_select->addOptionArray(array(0 => _AM_SBLEFT, 1 => _AM_SBRIGHT, 3 => _AM_CBLEFT, 4 => _AM_CBRIGHT, 5 => _AM_CBCENTER, 7 => _AM_CBBOTTOMLEFT, 8 => _AM_CBBOTTOMRIGHT, 9 => _AM_CBBOTTOM,2 => _AM_FREEBLOCK ));  // ezsky hack for block callback  add 2 => _AM_FREEBLOCK
