...
class PortfolioService extends XoopsObject
{
    function __construct() {
        ...
        $this->initVar('service_pid', XOBJ_DTYPE_INT, 0, false);
        ...
        $this->initVar('service_pushtime', XOBJ_DTYPE_INT, null, false);
        $this->initVar('service_datetime', XOBJ_DTYPE_INT, null, false);
        $this->initVar('service_status', XOBJ_DTYPE_INT, null, false);
        $this->initVar('service_weight', XOBJ_DTYPE_INT, null, false);
