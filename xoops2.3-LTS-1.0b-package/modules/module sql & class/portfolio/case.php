...
class PortfolioCase extends XoopsObject
{
    function __construct() {
        ...
        $this->initVar('service_id', XOBJ_DTYPE_INT, 0);
        ...
        $this->initVar('case_pushtime', XOBJ_DTYPE_INT);
        $this->initVar('case_datetime', XOBJ_DTYPE_INT);
        $this->initVar('case_status', XOBJ_DTYPE_INT, 0);
        $this->initVar('case_weight', XOBJ_DTYPE_INT,0);
