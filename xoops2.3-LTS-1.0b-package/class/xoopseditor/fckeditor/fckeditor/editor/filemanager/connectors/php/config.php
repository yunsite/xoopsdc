...
// Customized for XOOPS
// User file path pattern for folder names, possible values: Ym, one folder per month; Y, one folder per year; empty, in side one folder
$Config['UserFilesPathPattern'] = "Ym" ;

// User file name pattern, possible values: date - YmdHis; time - unixtime; uid - userid prepad with 0; empty, original name; |, combination
$Config['UserFilesNamePattern'] = "date" ;
?>
