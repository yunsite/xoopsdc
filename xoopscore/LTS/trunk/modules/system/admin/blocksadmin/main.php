...
if ( $op == "save" ) {
    ...
    save_block($bside, $bweight, $bvisible, $btitle, $bname, $bcontent, $bctype, $bmodule, $bcachetime);
    exit();
}
...
if ( $op == "update" ) {
    ...
    update_block($bid, $bside, $bweight, $bvisible, $btitle, $bname, $bcontent, $bctype, $bcachetime, $bmodule, $options);
}
...
if ($op == 'clone_ok') {
    $options = isset($options) ? $options : array();
    $bcontent = isset($bcontent) ? $bcontent : '';
    clone_block_ok($bid, $bside, $bweight, $bvisible, $btitle, $name, $bcontent, $bcachetime, $bmodule, $options);
}
