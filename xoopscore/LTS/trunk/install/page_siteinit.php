 ...
 * @version     $Id: page_siteinit.php 2867 2009-02-25 05:33:37Z phppp $
**/
    ...
    <fieldset>
        ...
        <div id="password">
            ...
            <div id="passwordmetter" class="xoform-help">
                <label for='passwordStrength'><strong><?php echo PASSWORD_LABEL; ?></strong></label>
                <div id='passwordStrength' class='strength0'>
                    <span id='passwordDescription'><?php echo PASSWORD_DESC; ?></span>
                </div>

                <label for='password_generator'><strong><?php echo PASSWORD_GENERATOR; ?></strong></label>
