...
global $xoopsLogger, $xoopsModule, $xoopsModuleConfig;
...
$spotlight_data = isset($_POST['spotlight_data']) ? $_POST['spotlight_data'] : $spotlight_data;
...
switch ($ac) {    
    ...
    case 'add':
        ...
        $form = new XoopsThemeForm(_MA_SPOTLIGHT_KEEP_PUSHING_FOCUS, 'form', $action, 'post', true);
    		...
    		$page_image->addElement(new XoopsFormLabel('',_MA_SPOTLIGHT_ADD_PAGE_ALLOW_UPLOAD_TYPE));
