...
function flash3dComponentsShow($options)
{
global $xoopsModuleConfig;
    include_once XOOPS_ROOT_PATH."/modules/spotlight/components/flash3d/config.php";
    ...
    foreach ($pages as $k=>$v){
      	...
      	$block['images'][] = XOOPS_UPLOAD_URL.'/spotlight/'.'thumb_'.$v['page_image'].'|_|'.XOOPS_UPLOAD_URL.'/spotlight/'.'image_'.$v['page_image'].'|||';
    }
    ...
    $block['images'] = implode('|_|',$block['images']);
